  ...
  return (
    <div className="relative inline-block">
      <select
        ...
        className="text-gray-300  bg-[#161B22] ring-1 ring-white/10  rounded-lg pl-8 md:py-3  pr-2 py-2 font-medium transition-all duration-200 hover:bg-[#1C2128] focus:outline-none focus:ring-2 focus:ring-teal-500"
      >
        <option
          value="none"
